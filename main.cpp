...
/*
* ќсновные функции обработки данных (вычисл€ет историю движени€ и обнаружени€ движени€)
*/
static void update_mhi(IplImage* img, IplImage* dst, int diff_threshold)
{
	...
	/*
	* –аспределить картинки в начале или перераспределить их, если размер кадра изменилс€	*/
	...
	/*
	* преобразование MHI к зеленому 8u изображению
	*/
	...
	/*
	* расчет движени€ ориентации градиента и  маски
	*/
